...
-- ---------------------------------------------------------------------
-- 1. TAGS — тонкие пометки.
-- ---------------------------------------------------------------------
INSERT INTO tags (name, slug, description, usage_count) VALUES
    ('Новогоднее',         'newyear',       'Атмосфера праздника, снег, ёлки',         0),
    ('Хеллоуин',           'halloween',     'Для тематической ночи 31 октября',        0),
    ('Ностальгия',         'nostalgia',     'Тёплое чувство по прошлому, ретро',       0),
    ('Культовое',          'cult',          'Признанная классика, must-watch',         0),
